...
export class CustomResponse {
  ...
  static notFound(res: Response, message: string | false, errors: any = null) {
  ...
  static forbidden(res: Response, message: string | false, errors: any = null) {
    new CustomResponse(res, 403, message ? message : "Forbidden", null, errors);
  }

  static internal(res: Response, message: string | false, errors: any = null) {
    new CustomResponse(
      res,
      500,
